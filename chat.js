...
document.addEventListener('DOMContentLoaded', () => {
  ...
  style.textContent = `
    ...
    .jb-chat__header {
      ...
      background: linear-gradient(135deg,#0e3a5b,#1a5b87);
  ...
  panel.innerHTML = `
    ...
    <form id="jb-chat-form" class="jb-chat__input">
    ...
    <div class="jb-chat__footer">
      <small>
        By continuing you agree JBIS may contact you (message/data rates may apply). You can opt out anytime. We don’t sell your data; it’s only used for quoting.
  ...
  function currentValue(){
    ...
    const el=inputWrap.querySelector('.field,select,textarea');
    return el?el.value:'';
  }
  ...
  form.addEventListener('submit', e=>{
    ...
    user(typeof v==='string'?v:'✓'); data[steps[idx].key]=v;
